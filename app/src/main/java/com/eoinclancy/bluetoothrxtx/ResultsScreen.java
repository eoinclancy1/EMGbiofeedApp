...
public class ResultsScreen extends AppCompatActivity {
    ...
    public String getEmailBody(EmailInformation info) {
        ...
        String s2 = "Number of squats targeted: " + 2 + "\n";
        String s3 = "Number of squats completed: " + 1 + "\n";

        String s4 = "Max Squatting Angle = " + 120 +"\n";
        String s5 = "Max Difference in Squatting Angles = " + 9 + "\n\n";
